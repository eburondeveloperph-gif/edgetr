...
export default function Header() {
  ...
  const { ollamaModel, isOllamaConnected, supertonicVoice } = useSettings();
      ...
      <div className="header-left">
        <div className="flex items-center gap-2.5">
          ...
          <button
            ...
            title="Click to change Ollama model in Settings"
          >
            <span className={`w-2 h-2 rounded-full ${isOllamaConnected ? 'bg-emerald-400 animate-pulse' : 'bg-amber-400'}`}></span>
